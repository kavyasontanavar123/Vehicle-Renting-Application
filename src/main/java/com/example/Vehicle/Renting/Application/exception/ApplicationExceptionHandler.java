...
public class ApplicationExceptionHandler {
	...
	@ExceptionHandler
	public ResponseEntity<ErrorStructure<String>> handleFailedToUploadException(FailedToUploadException ex) {
		return ResponseEntity.status(HttpStatus.NOT_FOUND)
				.body(ErrorStructure.create(HttpStatus.NOT_FOUND.value(),ex.getMessage(),"Failed to upload the image"));
	
	}
	@ExceptionHandler
	public ResponseEntity<ErrorStructure<String>> handleImageNotFoundByIdException(ImageNotFoundByIdException ex) {
		return ResponseEntity.status(HttpStatus.NOT_FOUND)
				.body(ErrorStructure.create(HttpStatus.NOT_FOUND.value(),ex.getMessage(),"Failed to find the image"));
	
	}
	@ExceptionHandler
	public ResponseEntity<ErrorStructure<String>> handleVehicleNotFoundByIdExcepction(VehicleNotFoundByIdExcepction ex) {
		return ResponseEntity.status(HttpStatus.NOT_FOUND)
				.body(ErrorStructure.create(HttpStatus.NOT_FOUND.value(),ex.getMessage(),"user not found by the given ID"));
	...
	@ExceptionHandler
	public ResponseEntity<ErrorStructure<String>> handleVehicleNotFoundException(VehicleNotFoundException ex) {
		return ResponseEntity.status(HttpStatus.NOT_FOUND)
				.body(ErrorStructure.create(HttpStatus.NOT_FOUND.value(),ex.getMessage(),"Failed to find vehicle"));
	
	}
	@ExceptionHandler
	public ResponseEntity<ErrorStructure<String>> handleLocationNotFoundException(LocationNotFoundException ex) {
		return ResponseEntity.status(HttpStatus.NOT_FOUND)
